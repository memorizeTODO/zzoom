...
public class NoticeController {
	...
	public String noticeinsert(NoticeVO notice,HttpSession session) {
	...
	public String noticelist(@RequestParam(value = "page", defaultValue = "1") int page, Model model,HttpSession session) {
