...
<nav class="bg-white fixed w-full z-20 top-0 start-0 border-b border-gray-200">
  ...
  <form method="post" action="member_login" class="max-w-sm mx-auto" onsubmit="return check()">
    ...
    <div class="grid gap-6 mb-6 md:grid-cols-1">
      <button type="submit"
        class="text-white bg-purple-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-auto sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">로그인</button>
  	</div>
  	
    <div class="grid gap-6 mb-6 md:grid-cols-3">
      <button type="button" onClick="location='join'"
        class="text-white bg-purple-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-auto sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">회원가입</button>
      <button type="button" onClick="id_find();"
        class="text-white bg-purple-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-auto sm:w-auto px-3 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">아이디 찾기</button>
      <button type="button" onClick="passwd_find();"
        class="text-white bg-purple-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-auto sm:w-auto px-2 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">비밀번호 찾기</button>
       </div>
  </form>
</div>
</body>
