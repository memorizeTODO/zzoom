...
<body class="bg-gray-100 h-500 w-450">
  <div class="bg-white shadow-md rounded m-80 p-40 scroll-m-0">
    <h1 class="text-center text-xl font-bold">비밀번호 찾기</h1><br/>
  <form method="post" action="findPasswd" class="max-w-sm mx-auto" onsubmit="return check()">
    <div class="mb-5">
...
<body class="bg-gray-100 h-500 w-450">
  <div class="bg-white shadow-md rounded m-80 p-40 scroll-m-0">
    <h1 class="text-center text-xl font-bold">비밀번호 찾기 결과</h1><br/>
    <div class="mb-5">
      <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white font-bold">회원 비밀번호</label>
      <input type="text" name="member_passwd" id="member_passwd" value="${mem.member_passwd}"
    ...
    <input type="button" value="닫기" class="text-white bg-purple-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-auto sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
    onclick="self.close();" />
    </div>
</div>
</c:if>
