...
<body class="bg-gray-100 h-500 w-450">
  ...
  <form method="post" action="delete" class="max-w-sm mx-auto" onsubmit="return check()">
    ...
    <div class="grid gap-6 mb-6 md:grid-cols-2">
      ...
      <button type="reset" 
        class="text-white bg-purple-400 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-auto sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick="history.go(-1);">취소</button>
    </div>
  </form>
</div>
</c:if>
