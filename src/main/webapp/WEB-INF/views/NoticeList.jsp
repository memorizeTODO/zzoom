...
<body class="bg-gray-100">
	...
	<div class="text-center text-gray-600 text-3xl font-bold mt-40 mb-5">공지사항</div>
	...
	<form class="max-w-md mx-auto">
		...
		<input type="search" id="noticesearch"  placeholder="  검색어를 입력하세요." required 
			class="block w-full p-3 ps-7 text-sm text-gray-900 border border-purple-700 rounded-lg bg-gray-50 focus:ring-purple-500 focus:border-purple-500"/>
		<button type="submit" 
			class="text-white absolute end-1 top-1 bottom-1 bg-purple-700 hover:bg-purple-500 focus:ring-2 focus:outline-none focus:ring-purple-500 font-medium rounded-lg text-sm px-4 py-2">
			검색
		</button>
		</div>
	</form>
	...
	<!-- 공지사항 목록 출력 -->
	<div class="container mx-auto mt-3 border-collapse" align="center">
