...
<body>
    ...
    <div class="main hide" id="meetingroom">
        ...
        <div class="fixed bottom-0 left-0 z-50 bottom-bar-layout dark:bg-gray-700 dark:border-gray-600"> <!--하단 네비게이터 바-->
            ...
            <div class="flex flex-row h-auto w-auto mx-auto flex-nowrap font-medium" id="user_ui_options"><!--플렉스 컨테이너-->
                ...
                <div class="flex flex-row">
                    <button class="btn btn-warning btn-xs" data-drawer-target="drawer-navigation" data-drawer-show="drawer-navigation" aria-controls="drawer-navigation" style="margin-right: 0.5rem">
        ...
        <!-- drawer init and show -->
            ...
            <!-- drawer component -->
            <div id="drawer-navigation" class="fixed top-0 right-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
