...
<body class="bg-gray-100">
	<div class="flex justify-center text-gray-600 text-2xl font-bold mt-40 mb-2">공지 수정</div>
		...
		<form action="update_notice" method="post">
			...
			<div class="mb-6">
				<label for="notice_subject"
					...
					class="bg-gray-50 border border-purple-700 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
			...
			<div class="mb-6">
				...
				<textarea id="notice_content" name="notice_content" rows="5"
					class="bg-gray-50 border border-purple-700 text-gray-900 text-sm rounded-lg block w-full p-2 "
			...
			<div class="flex justify-between">
				...
				<!-- 공지 작성 버튼 -->
				<button type="submit"
					class="text-white bg-purple-700 hover:bg-purple-500 focus:ring-4 focus:outline-none focus:ring-purple-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
					수정</button>
