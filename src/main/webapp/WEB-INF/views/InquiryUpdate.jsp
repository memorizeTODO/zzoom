...
<body class="bg-gray-100">
	...
	<div class="mb-2">
		<label for="inquiry_content"
			class="lock mb-2 text-md font-bold text-purple-500">
			문의내용
		</label>
		<div class="flex flex-center">
	...
	<div class="flex justify-between mt-5">
		<!-- 문의 작성 버튼 -->
		<button type="submit"
			class="text-white bg-purple-700 hover:bg-purple-400 focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
			수정
		</button>
